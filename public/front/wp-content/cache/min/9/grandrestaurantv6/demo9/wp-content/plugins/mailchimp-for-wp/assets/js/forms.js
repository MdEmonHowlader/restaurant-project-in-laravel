            ...
            1677: function() {
                function e(e) {
                    ...
                    for (let e = 0; e < i.length; e++) {
                        const t = i[e];
                        if (s = o.indexOf(t) > -1 || o.indexOf("*") > -1 && t.length > 0, s) break
                    }
                    e.style.display = t ? s ? "" : "none" : s ? "none" : "";
                    const a = e.querySelectorAll("input,select,textarea");
                    for (let e = 0; e < a.length; e++) {
                        const n = a[e];
                        (s || t) && n.getAttribute("data-was-required") && (n.required = !0, n.removeAttribute("data-was-required")), s && t || !n.required || (n.setAttribute("data-was-required", "true"), n.required = !1)
                    }
                }
            ...
            8592: function(e, t, n) {
                ...
                e.exports = {
                    ...
                    trigger: function(e, t) {
                        "submit" === e || e.indexOf(".submit") > 0 ? (i.emit(t[0].id + "." + e, t), i.emit(e, t)) : window.setTimeout((function() {
                            i.emit(t[0].id + "." + e, t), i.emit(e, t)
                        }), 10)
                    }
                }
            },
                ...
                e.exports = function(e, r) {
                    ...
                    for (var o = r.hash ? {} : "", a = r.serializer || (r.hash ? i : s), c = e && e.elements ? e.elements : [], l = Object.create(null), u = 0; u < c.length; ++u) {
                        ...
                        if ((r.disabled || !f.disabled) && f.name && n.test(f.nodeName) && !t.test(f.type)) {
                            ...
                            if ("select-multiple" !== f.type) o = a(o, d, h);
                            else {
                                h = [];
                                for (var p = f.options, m = !1, g = 0; g < p.length; ++g) {
                                    var y = p[g],
                                        v = r.empty && !y.value,
                                        b = y.value || v;
                                    y.selected && b && (m = !0, o = r.hash && "[]" !== d.slice(d.length - 2) ? a(o, d + "[]", y.value) : a(o, d, y.value))
                                }!m && r.empty && (o = a(o, d, ""))
                            }
                        }
                    }
                    if (r.empty)
                        for (var d in l) l[d] || (o = a(o, d, ""));
                    return o
                }
            },
            3409: function(e) {
                e.exports && (e.exports = function e(t, n, r) {
                    for (const o in n) {
                        ...
                        const i = o;
                        let s = n[o];
                        if (void 0 === s && (s = ""), null === s && (s = ""), void 0 !== r && (i = r + "[" + o + "]"), s.constructor === Array) i += "[]";
